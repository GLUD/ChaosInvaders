 ...
 * @author Alejandro
 */
public class MenuBeta extends javax.swing.JFrame {

    /**
     * Creates new form MenuBeta
     */
    public MenuBeta() {
        initComponents();
    }
    ...
    private void BotonIniciarJuegoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonIniciarJuegoActionPerformed
     JFrame f = new JFrame("NOmbre poner despues xD");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuBeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
